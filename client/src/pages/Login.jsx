...
const Login = () => {
  ...
  const fillQuickLogin = (role) => {
    if (role === 'user') {
      ...
      toast.success('⚡ Filled User credentials!');
    } else {
      setEmail('vishwa124@gmail.com');
      setPassword('Vishwa@45');
      toast.success('⚡ Filled Admin credentials (Vishwa)!');
    }
  };
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-5xl z-10 my-6">
        ...
        >
          ...
          {/* Interactive Feature Cards with Rich Mouse Hover Color Shifts */}
